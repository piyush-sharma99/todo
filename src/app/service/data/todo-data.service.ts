...
export class TodoDataService {
  ...
  RetrieveAllTodos(username: string) {
    return this.httpRequest.get<todo[]>(`${API_URL}/users/${username}/todos`); // The <> tells the http client the structure of the response I am expecting.
  }
  ...
  AddTodos(username: string, id: number, todo: todo) {
    return this.httpRequest.post(`${API_URL}/users/${username}/todos`, todo); // The <> tells the http client the structure of the response I am expecting.
  }
}
